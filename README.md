...
## react-study
- 아래 학습 완료 이후 개발 환경 구축과 함께 개발한 영화 웹앱
- 자세한 내용은 아래 사이트
- 개발했던 코드 업로드
- [영화 웹앱](https://github.com/jysung1122/react-movie)
...
10. Publishing : GitHub Pages에 업로드할 수 있게 해주는 패키지 다운
    ...
    10-1에 작성한 https://jysung1122.github.io/react-movie 열고 실행 확인
       ```
